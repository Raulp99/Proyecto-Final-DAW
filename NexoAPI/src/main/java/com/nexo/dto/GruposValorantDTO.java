...
public class GruposValorantDTO {
	...
	public GruposValorantDTO() {
		super();
		// TODO Auto-generated constructor stub
	}

	public GruposValorantDTO(Integer idGrupo, String tituloGrupo, String modoJuego, String rangoCompetitivo,
			...
			String nombreEnJuegoLiderGrupo, String nombreEnJuegoJugador1, String nombreEnJuegoJugador2,
			String nombreEnJuegoJugador3, String nombreEnJuegoJugador4, LocalDateTime fechaCreacion,
			Integer grupoActivo) {
		super();
