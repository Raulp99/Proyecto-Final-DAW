...
@Entity
@Table(name = "grupos_league_of_legends")
public class GruposLoLEntity {
	@Id
	...
	public GruposLoLEntity() {
		super();
		// TODO Auto-generated constructor stub
	}

	public GruposLoLEntity(Integer idGrupo, String tituloGrupo, String modoJuego, String rangoCompetitivo,
