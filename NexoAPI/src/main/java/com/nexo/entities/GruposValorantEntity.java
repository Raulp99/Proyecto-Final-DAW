...
@Entity
@Table(name = "grupos_valorant")
public class GruposValorantEntity {
	...
	public GruposValorantEntity() {
		super();
		// TODO Auto-generated constructor stub
	}

	public GruposValorantEntity(Integer idGrupo, String tituloGrupo, String modoJuego, String rangoCompetitivo,
