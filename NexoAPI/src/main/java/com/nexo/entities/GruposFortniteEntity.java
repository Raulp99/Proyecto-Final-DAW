...
@Entity
@Table(name = "grupos_fortnite")
public class GruposFortniteEntity {
	...
	public GruposFortniteEntity() {
		super();
		// TODO Auto-generated constructor stub
	}

	public GruposFortniteEntity(Integer idGrupo, String tituloGrupo, String modoJuego, Integer numeroJugadores,
			String region, String microfonoRequerido, String descripcion, String liderGrupo, String jugador1,
			String jugador2, String jugador3, String discordLiderGrupo, String discordJugador1, String discordJugador2,
			String discordJugador3, LocalDateTime fechaCreacion, Integer grupoActivo) {
		super();
