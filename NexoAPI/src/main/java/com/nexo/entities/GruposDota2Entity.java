...
@Entity
@Table(name = "grupos_dota2")
public class GruposDota2Entity {
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "idGrupo")
	private Integer idGrupo;

	@Column(name = "tituloGrupo")
	private String tituloGrupo;

	@Column(name = "modoJuego")
	private String modoJuego;

	@Column(name = "rangoCompetitivo")
	...
	@Column(name = "discordLiderGrupo")
	private String discordLiderGrupo;

	@Column(name = "discordJugador1")
	private String discordJugador1;

	@Column(name = "discordJugador2")
	private String discordJugador2;

	@Column(name = "discordJugador3")
	private String discordJugador3;

	@Column(name = "discordJugador4")
	private String discordJugador4;

	@Column(name = "fechaCreacion")
	private LocalDateTime fechaCreacion;

	@Column(name = "grupoActivo")
	private Integer grupoActivo;

	public GruposDota2Entity() {
		super();
		// TODO Auto-generated constructor stub
	}

	public GruposDota2Entity(Integer idGrupo, String tituloGrupo, String modoJuego, String rangoCompetitivo,
			...
			String discordJugador2, String discordJugador3, String discordJugador4, LocalDateTime fechaCreacion,
			Integer grupoActivo) {
		super();
