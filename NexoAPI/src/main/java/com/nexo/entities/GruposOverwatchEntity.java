...
@Entity
@Table(name = "grupos_overwatch")
public class GruposOverwatchEntity {
	...
	public GruposOverwatchEntity() {
		super();
		// TODO Auto-generated constructor stub
	}

	public GruposOverwatchEntity(Integer idGrupo, String tituloGrupo, String modoJuego, String rangoCompetitivo,
