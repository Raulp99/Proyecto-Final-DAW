<template>
  <div id="contenedor-overwatch">
    <header class="contenedor-header-overwatch mb-4">
            ...
            <div class="border p-2 contenedor-miembros">
              ...
              <div class="contenedor-miembro">
                ...
                <div class="nombre-jugador">
                  <img
                    src="@/assets/img/overwatch/overwatch-icon.png"
                    alt=""
                    class="icono"
                    title="Overwatch 2"
                  />
          ...
          >
            ...
            <fieldset>
              ...
              <div class="form-group mb-3">
                <label for="nombre">Nombre de usuario en Overwatch 2</label>
                <input
                  type="text"
                  class="form-control"
                  id="liderGrupo"
            ...
            <fieldset>
              ...
              <div class="form-group mb-3">
                ...
                >
                  ...
                  <option value="Partida Rápida">Partida Rápida</option>
              ...
              <div class="form-group mb-3">
                ...
                >
                  ...
                  <option value="🇺🇸 Norteamérica">🇺🇸 América</option>
...
export default {
  ...
  data() {
    return {
      gruposOverwatch: "http://localhost:8081/nexo/gruposOverwatch",
      postsGrupos: [],
      idgrupo: "",
      tituloGrupo: "",
      modoJuego: "",
  ...
  methods: {
    async guardarGrupo() {
      ...
      this.grupoActivo = 1;
      try {
        const response = await axios.post(this.gruposOverwatch, {
    ...
    async modificarGrupo(id, j1, j2, j3, j4, d1, d2, d3, d4) {
      ...
      try {
        const response = await axios.put(
          this.gruposOverwatch + "/" + this.idgrupo,
          {
